...
class EfficientNet3D(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None, in_channels=3):
        ...
        # self._conv_stem = Conv3d(in_channels, out_channels, kernel_size=1, stride=2, bias=False)  #Adel
...
def efficientnet3d(**kwargs):

    model = EfficientNet3D.from_name("efficientnet-b0", override_params={'num_classes': 2}, in_channels=3)

    from torchsummary import summary
    summary(model, input_size=(3, 16, 112, 112))
    # summary(model, input_size=(3, 600, 600, 600))
