...
class Conv3dDynamicSamePadding(nn.Conv3d):
    ...
    def forward(self, x):
        ...
        # pad_h = max((oh - 1) * self.stride[0] + (kh - 1) * self.dilation[0] + 2 - ih, 0)  #Adel
        ...
        if pad_h > 0 or pad_w > 0 or pad_z > 0:
            ...
            # x = F.pad(x, [pad_w // 2 +1, pad_w - pad_w // 2, pad_h // 2, pad_h - pad_h // 2, pad_z // 2, pad_z - pad_z // 2]) #Adel
...
class Conv3dStaticSamePadding(nn.Conv3d):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, image_size=None, **kwargs):
        ...
        if pad_h > 0 or pad_w > 0 or pad_z > 0:
            ...
            # self.static_padding = nn.ZeroPad2d((pad_w // 2 +1, pad_w - pad_w // 2, pad_h // 2, pad_h - pad_h // 2, pad_z // 2, pad_z - pad_z // 2)) #Adel
        else:
    ...
    def forward(self, x):
        ...
        # x = F.conv3d(x, self.weight.to('cuda'), self.bias, self.stride, self.padding, self.dilation, self.groups)
...
def efficientnet3d(width_coefficient=None, depth_coefficient=None, dropout_rate=0.2,
    ...
    #     'r1_k3_s111_e6_i192_o320_se0.25',] # ORIGINAL
#     blocks_args = [
#         'r1_k1_s222_e1_i32_o16_se0.25', 'r2_k1_s222_e6_i16_o24_se0.25',
#         'r2_k1_s222_e6_i24_o40_se0.25', 'r3_k1_s222_e6_i40_o80_se0.25',
#         'r3_k1_s111_e6_i80_o112_se0.25', 'r4_k1_s222_e6_i112_o192_se0.25',
#         'r1_k1_s111_e6_i192_o320_se0.25',
# ]
    blocks_args = [
        'r1_k3_s111_e1_i32_o16_se0.25', 'r2_k3_s111_e6_i16_o24_se0.25',
        'r2_k5_s222_e6_i24_o40_se0.25', 'r3_k3_s111_e6_i40_o80_se0.25',
        'r3_k5_s111_e6_i80_o112_se0.25', 'r4_k5_s222_e6_i112_o192_se0.25',
