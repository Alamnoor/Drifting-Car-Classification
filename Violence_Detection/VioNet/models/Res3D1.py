...
## changes
from models.Torch.mish import Mish
...
class ResBlock(nn.Module):
    def __init__(self, input_channel, output_channel, stride = 1, init_method = 'kaiming_normal_'):
        ...
        self.w_1 = nn.Conv3d(self.in_channel, self.out_channel, kernel_size = 3, \
    ...
    def forward(self, input): 
        ...
        step_2 = self.Mish(self.bn_2(self.w_2(step_1)))
        step_3 = self.bn_3(self.w_3(step_2))
        step_3 = self.Mish(step_3 + step_1)
        step_4 = self.Mish(self.bn_4(self.w_4(step_3)))
        step_5 = self.bn_5(self.w_5(step_4))
        step_5 = self.Mish(step_5 + step_3)
        return step_5
...
class Res3D(nn.Module):
    ...
    def forward(self, input): 
        block1 = self.Mish(self.bn(self.w_1(input)))
